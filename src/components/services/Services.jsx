        ...
        <div className="services-wrapper">
            ...
            <div className="services-items__wrapper">
              ...
              <div className="services-item">
                ...
                <Link activeClass="active" to="home" spy={true} smooth={true} offset={0}duration={500}><button className='services-item__button'>Mám zájem</button></Link>
              </div>
              ...
              <div className="services-item">
                ...
                <Link activeClass="active" to="contact" spy={true} smooth={true} offset={0}duration={500}><button className='services-item__button'>Mám zájem</button></Link>
              </div>
